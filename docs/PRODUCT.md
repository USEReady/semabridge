...
|-----------|------|----------|
| **Forward Sync** | Snowflake → Fabric | Deploy Snowflake data models to Power BI |
| **Reverse Sync** | Fabric → Snowflake | Export Fabric models to Snowflake Semantic Views |
...
|----------|---------|--------|
| **Snowflake** | ✅ INFORMATION_SCHEMA | ✅ Semantic Views, Cortex YAML |
| **Microsoft Fabric** | ✅ REST API (getDefinition) | ✅ model.bim via REST API |
