...
class SnowflakeConfig(BaseSettings):
    ...
    authenticator: Optional[str] = Field(default=None, description="Snowflake authenticator override")
    # OAuth S2S (External OAuth client-credentials grant)
    oauth_client_id: Optional[str] = Field(default=None, description="OAuth client ID for External OAuth S2S auth")
