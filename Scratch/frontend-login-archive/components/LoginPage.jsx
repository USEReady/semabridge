 ...
 * Shown when no valid JWT token is present.
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Success message */}
        {successMsg && (
          <div className="flex items-center gap-2 px-3 py-2 mb-4 rounded-md text-xs font-medium"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="h-9 px-3 rounded-md text-sm bg-app border border-main text-primary placeholder:text-tertiary focus:outline-none focus:ring-2 focus:ring-accent-blue/40 focus:border-accent-blue transition"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-9 px-3 pr-9 rounded-md text-sm bg-app border border-main text-primary placeholder:text-tertiary focus:outline-none focus:ring-2 focus:ring-accent-blue/40 focus:border-accent-blue transition"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="flex items-center justify-center gap-2 h-9 rounded-md text-sm font-medium transition"
            style={{
        ...
        <div className="mt-6 text-center text-xs text-tertiary">
          {mode === 'login' ? (
            <>
              ...
              <button onClick={() => switchMode('register')} className="text-accent-blue hover:underline font-medium">
                Sign up
              </button>
            </>
          ) : (
            <>
              ...
              <button onClick={() => switchMode('login')} className="text-accent-blue hover:underline font-medium">
                Sign in
              </button>
            </>
          )}
